# CIS Landing Zone - Cisco Secure Firewall Threat Defense

CIS Landing Zone template deploys a standardized environment in an Oracle Cloud Infrastructure (OCI) tenancy that helps organizations to comply with the [CIS OCI Foundations Benchmark v1.1](https://www.cisecurity.org/benchmark/oracle_cloud/). In this repo, you will be utilizing CIS landing Zone which you have created successfully then deploy Cisco Secure Firewall Threat Defense in active/active mode with dynamic routing gateway and network load balancers to communicate between VCNs. 
...
1. Click [![Deploy to Oracle Cloud](https://oci-resourcemanager-plugin.plugins.oci.oraclecloud.com/latest/deploy-to-oracle-cloud.svg)](https://console.us-phoenix-1.oraclecloud.com/resourcemanager/stacks/create?region=home&zipUrl=https://github.com/oracle-quickstart/oci-cisco/raw/master/cis-landing-zone/resource-manager/cis-landing-zone.zip)
...
8. At this stage your architecture should have been deployed successfully. You can proceed to next section for configuring your Cisco Threat Defense Firewall.
...
3. Create a `terraform.tfvars` file in your **cis-landing-zone** directory, and specify the following variables:
    ...
    nlb_subnet_cidr_block    = <cis_dmz_vcn_new_nlb_subnet_cidr>: Example: "10.0.52.0/24"
    ````
...
## Cisco Threat Defense Firewalls Subnets/Interfaces Mapping

Since you are using **CIS landing zone** to create your environment, you will see different subnet name but to clear any confusion you can follow table which reflect subnet names as per Cisco Secure Firewall Threat Defense standards: 
